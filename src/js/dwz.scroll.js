    ...
    $.fn.extend({
        ...
        scroll: function(options) {
            ...
            return this.each(function(){
                ...
                function getScrollW(){
                    var scrollW = $main.get(0).clientWidth - $wrap.get(0).clientWidth;
                    return scrollW > 0 ? scrollW : 0;
                }
                function getScrollH() {
                    var scrollH = $main.get(0).clientHeight - $wrap.get(0).clientHeight;
                ...
                $wrap.touchwipe({
                    ...
                    touchstart: function (pos, event) {
                        ...
                        if (op.touchstart) op.touchstart.call($main, pos, event);
                    },
                    touchmove: function (pos, event) {
                        ...
                        if (op.scrollY) {
                            ...
                            if (scrollY>0) {scrollY = scrollY/3}
                            else if (scrollY < -scrollH) {scrollY = (scrollY+scrollH)/3 - scrollH}
                        ...
                        if (op.scrollX) {
                            ...
                            if (scrollX>0) {scrollX = scrollX/3}
                            else if (scrollX < -scrollW) {scrollX = (scrollX+scrollW)/3 - scrollW}
                    ...
                    touchend: function (pos, event) {
                        ...
                        if (op.touchend) op.touchend.call($main, pos, event);
                    }
                });
            });
        }
